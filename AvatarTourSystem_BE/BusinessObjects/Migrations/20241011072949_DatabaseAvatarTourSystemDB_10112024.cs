...
{
    /// <inheritdoc />
    public partial class DatabaseAvatarTourSystemDB_10112024 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "ffb7fedd-0c82-48fa-a633-d4a79f23e531", 0, "Quận 10, Hồ chí minh", "data:image/png;base64,iVBO", "a5980b5f-1f95-451e-a1e2-3724287ccd59", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(6618), new DateTime(1990, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "huahao04@gmail.com", false, "Hứa Thượng Hảo", true, false, null, null, null, null, "0395840777", false, null, null, null, "154cb084-09a7-4acf-81af-eb88ff2227e4", 0, false, null, null, "" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "Hồ Chí Minh", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(5663), 0, null },
                    { "2", "Hà Nội", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(5728), 1, null }
                });

            migrationBuilder.InsertData(
                table: "PaymentMethod",
                columns: new[] { "PaymentId", "CreateDate", "PaymentType", "Status", "UpdateDate" },
                values: new object[] { "1", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7794), "Momo", 0, null });

            migrationBuilder.InsertData(
                table: "RequestType",
                columns: new[] { "RequestTypeId", "CreateDate", "Priority", "Status", "Type", "UpdateDate" },
                values: new object[] { "1", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(8012), 1, 0, "Support", null });

            migrationBuilder.InsertData(
                table: "Revenue",
                columns: new[] { "RevenueId", "CreateDate", "RevenueDate", "Status", "TotalRevenue", "UpdateDate" },
                values: new object[] { "1", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7752), new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7751), 0, 900000f, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(6822), "Tour", 0, null },
                    { "2", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(6826), "Hotel", 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(6768), 0, "FPT", null },
                    { "2", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(6771), 1, "VNPT", null }
                });

            migrationBuilder.InsertData(
                table: "CustomerSupport",
                columns: new[] { "CusSupportId", "CreateDate", "DateResolved", "Description", "RequestTypeId", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7972), new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7972), "Support", "1", 0, null, "ffb7fedd-0c82-48fa-a633-d4a79f23e531" });

            migrationBuilder.InsertData(
                table: "Destination",
                columns: new[] { "DestinationId", "CityId", "CreateDate", "DestinationAddress", "DestinationGoogleMap", "DestinationHotline", "DestinationImgUrl", "DestinationName", "Status", "UpdateDate" },
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7110), null, null, null, null, "Quận 1", 0, null },
                    { "2", "2", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7115), null, null, null, null, "Quận 2", 1, null }
                });

            migrationBuilder.InsertData(
                table: "Notification",
                columns: new[] { "NotifyId", "CreateDate", "Message", "SendDate", "Status", "Title", "Type", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7937), "Chúc mừng bạn đã đặt tour thành công", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7935), 0, "Thành công", "Success", null, "ffb7fedd-0c82-48fa-a633-d4a79f23e531" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7257), null, "Tour Hồ Chí Minh", 500000f, 0, null },
                    { "2", "2", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7260), null, "Tour Hà Nội", 600000f, 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(6883), null, null, "Tour Hồ Chí Minh", null, "1", 0, "1", null },
                    { "2", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(6960), null, null, "Tour Hà Nội", null, "1", 1, "2", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7435), null, "1", 0, "Vé người lớn (>=16 tuổi)", null },
                    { "2", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7438), null, "1", 1, "Vé trẻ em", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7051), "1", "1", 0, null },
                    { "2", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7056), "2", "2", 1, null }
                });

            migrationBuilder.InsertData(
                table: "Booking",
                columns: new[] { "BookingId", "BookingDate", "CreateDate", "DailyTourId", "ExpirationDate", "PaymentId", "Status", "TotalPrice", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7489), new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7491), "1", null, "1", 0, 500000f, null, "ffb7fedd-0c82-48fa-a633-d4a79f23e531" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", 10, new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7308), null, "1", 0, "1", null },
                    { "2", 10, new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7311), null, "1", 1, "2", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7211), "1", "Chợ Bến Thành", 0, null },
                    { "2", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7213), "1", "Bảo tàng Hồ Chí Minh", 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(6999), "1", 0, "1", null },
                    { "2", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7003), "2", 1, "2", null }
                });

            migrationBuilder.InsertData(
                table: "BookingByRevenue",
                columns: new[] { "BookingByRevenueId", "BookingId", "CreateDate", "RevenueId", "Status", "UpdateDate" },
                values: new object[] { "1", "1", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7697), "1", 0, null });

            migrationBuilder.InsertData(
                table: "Feedback",
                columns: new[] { "FeedbackId", "BookingId", "CreateDate", "FeedbackMsg", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7866), "Rất tuyệt vời", 0, null, "ffb7fedd-0c82-48fa-a633-d4a79f23e531" });

            migrationBuilder.InsertData(
                table: "Rate",
                columns: new[] { "RateId", "BookingId", "CreateDate", "RateStar", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7898), 5, 0, null, "ffb7fedd-0c82-48fa-a633-d4a79f23e531" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7541), 100000f, "", 10, 0, "Vé vào cổng", "1", null },
                    { "2", "1", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7545), 50000f, "", 10, 1, "Vé ăn uống", "1", null }
                });

            migrationBuilder.InsertData(
                table: "TransactionsHistory",
                columns: new[] { "TransactionId", "BookingId", "CreateDate", "OrderId", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7824), null, 0, null, "ffb7fedd-0c82-48fa-a633-d4a79f23e531" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7630), "1", 0, "1", null },
                    { "2", new DateTime(2024, 10, 11, 14, 29, 49, 272, DateTimeKind.Local).AddTicks(7633), "2", 1, "2", null }
                });
