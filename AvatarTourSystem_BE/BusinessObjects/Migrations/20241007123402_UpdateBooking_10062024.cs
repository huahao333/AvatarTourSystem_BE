...
{
    /// <inheritdoc />
    public partial class UpdateBooking_10062024 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "7567c79c-913c-488c-be76-33e9be6c5736", 0, "Quận 10, Hồ chí minh", "data:image/png;base64,iVBO", "2d3bca59-64b9-4534-8b3f-d35629df622a", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7536), new DateTime(1990, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "huahao04@gmail.com", false, "Hứa Thượng Hảo", true, false, null, null, null, null, "0395840777", false, null, null, null, "14ad4237-151f-4b19-86ad-9d28d8aa4fdb", 0, false, null, null, "" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "Hồ Chí Minh", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7291), 0, null },
                    { "2", "Hà Nội", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7308), 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7813), "Chợ", 0, null },
                    { "2", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7816), "Bảo tàng", 1, null }
                });

            migrationBuilder.InsertData(
                table: "PaymentMethod",
                columns: new[] { "PaymentId", "CreateDate", "PaymentType", "Status", "UpdateDate" },
                values: new object[] { "1", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(8086), "Momo", 0, null });

            migrationBuilder.InsertData(
                table: "RequestType",
                columns: new[] { "RequestTypeId", "CreateDate", "Priority", "Status", "Type", "UpdateDate" },
                values: new object[] { "1", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(8233), 1, 0, "Support", null });

            migrationBuilder.InsertData(
                table: "Revenue",
                columns: new[] { "RevenueId", "CreateDate", "RevenueDate", "Status", "TotalRevenue", "UpdateDate" },
                values: new object[] { "1", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(8066), new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(8064), 0, 900000f, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7611), "Tour", 0, null },
                    { "2", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7615), "Hotel", 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7582), 0, "FPT", null },
                    { "2", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7586), 1, "VNPT", null }
                });

            migrationBuilder.InsertData(
                table: "CustomerSupport",
                columns: new[] { "CusSupportId", "CreateDate", "DateResolved", "Description", "RequestTypeId", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(8214), new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(8213), "Support", "1", 0, null, "7567c79c-913c-488c-be76-33e9be6c5736" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7731), null, "Quận 1", 0, null },
                    { "2", "2", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7733), null, "Quận 2", 1, null }
                });

            migrationBuilder.InsertData(
                table: "Notification",
                columns: new[] { "NotifyId", "CreateDate", "Message", "SendDate", "Status", "Title", "Type", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(8170), "Chúc mừng bạn đã đặt tour thành công", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(8168), 0, "Thành công", "Success", null, "7567c79c-913c-488c-be76-33e9be6c5736" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7868), null, "Tour Hồ Chí Minh", 500000f, 0, null },
                    { "2", "2", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7871), null, "Tour Hà Nội", 600000f, 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7646), null, null, "Tour Hồ Chí Minh", null, "1", 0, "1", null },
                    { "2", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7649), null, null, "Tour Hà Nội", null, "1", 1, "2", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7759), "1", null, "Nhà hàng", 1, 0, null },
                    { "2", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7762), "1", null, "Khách sạn", 1, 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7942), "1", 0, "Vé người lớn (>=16 tuổi)", null },
                    { "2", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7944), "1", 1, "Vé trẻ em", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7701), "1", "1", 0, null },
                    { "2", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7708), "2", "2", 1, null }
                });

            migrationBuilder.InsertData(
                table: "Booking",
                columns: new[] { "BookingId", "BookingDate", "CreateDate", "DailyTourId", "ExpirationDate", "PaymentId", "Status", "TotalPrice", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7966), new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7968), "1", null, "1", 0, 500000f, null, "7567c79c-913c-488c-be76-33e9be6c5736" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", 10, new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7893), null, "1", 0, "1", null },
                    { "2", 10, new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7895), null, "1", 1, "2", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7789), "1", "1", "Chợ Bến Thành", 0, null },
                    { "2", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7791), "1", "2", "Bảo tàng Hồ Chí Minh", 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7674), "1", 0, "1", null },
                    { "2", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7677), "2", 1, "2", null }
                });

            migrationBuilder.InsertData(
                table: "BookingByRevenue",
                columns: new[] { "BookingByRevenueId", "BookingId", "CreateDate", "RevenueId", "Status", "UpdateDate" },
                values: new object[] { "1", "1", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(8045), "1", 0, null });

            migrationBuilder.InsertData(
                table: "Feedback",
                columns: new[] { "FeedbackId", "BookingId", "CreateDate", "FeedbackMsg", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(8127), "Rất tuyệt vời", 0, null, "7567c79c-913c-488c-be76-33e9be6c5736" });

            migrationBuilder.InsertData(
                table: "Rate",
                columns: new[] { "RateId", "BookingId", "CreateDate", "RateStar", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(8149), 5, 0, null, "7567c79c-913c-488c-be76-33e9be6c5736" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7995), 100000f, "", 10, 0, "Vé vào cổng", "1", null },
                    { "2", "1", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(7999), 50000f, "", 10, 1, "Vé ăn uống", "1", null }
                });

            migrationBuilder.InsertData(
                table: "TransactionsHistory",
                columns: new[] { "TransactionId", "BookingId", "CreateDate", "OrderId", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(8106), null, 0, null, "7567c79c-913c-488c-be76-33e9be6c5736" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(8022), "1", 0, "1", null },
                    { "2", new DateTime(2024, 10, 7, 19, 34, 1, 947, DateTimeKind.Local).AddTicks(8024), "2", 1, "2", null }
                });
