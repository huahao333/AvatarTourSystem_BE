...
{
    /// <inheritdoc />
    public partial class DatabaseAvatarTourSystemDB_09112024 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    POITypeId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    POITypeName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreateDate = table.Column<DateTime>(type: "date", nullable: true),
                    UpdateDate = table.Column<DateTime>(type: "date", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__POIType__511372467B17FFC3", x => x.POITypeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalRevenue = table.Column<float>(type: "real", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Revenue__511311221B17FEC3", x => x.RevenueId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    POITypeId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreateDate = table.Column<DateTime>(type: "date", nullable: true),
                    UpdateDate = table.Column<DateTime>(type: "date", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__PointOfInterest__POITypeId__3F21F217",
                        column: x => x.POITypeId,
                        principalTable: "POIType",
                        principalColumn: "POITypeId");
                });
            ...
            migrationBuilder.CreateTable(
                name: "BookingByRevenue",
                columns: table => new
                {
                    BookingByRevenueId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    RevenueId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__BookingByRevenue__551479477F27FEF9", x => x.BookingByRevenueId);
                    table.ForeignKey(
                        name: "FK__BookingByRevenue__BookingId__3A81D227",
                        column: x => x.BookingId,
                        principalTable: "Booking",
                        principalColumn: "BookingId");
                    table.ForeignKey(
                        name: "FK__BookingByRevenue__RevenueId__3A81C227",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "430f4760-a676-4dc0-8a3c-160016435da1", 0, "Quận 10, Hồ chí minh", "data:image/png;base64,iVBO", "2271de7f-ba43-4f5a-8a29-51eb184e3951", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(1660), new DateTime(1990, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "huahao04@gmail.com", false, "Hứa Thượng Hảo", true, false, null, null, null, null, "0395840777", false, null, null, null, "122d8dda-4765-4fea-82eb-2d68315deab5", 0, false, null, null, "" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "Hồ Chí Minh", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(1345), 0, null },
                    { "2", "Hà Nội", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(1359), 1, null }
                });

            migrationBuilder.InsertData(
                table: "POIType",
                columns: new[] { "POITypeId", "CreateDate", "POITypeName", "Status", "UpdateDate" },
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(1928), "Chợ", 0, null },
                    { "2", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(1930), "Bảo tàng", 1, null }
                });

            migrationBuilder.InsertData(
                table: "PaymentMethod",
                columns: new[] { "PaymentId", "CreateDate", "PaymentType", "Status", "UpdateDate" },
                values: new object[] { "1", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(2187), "Momo", 0, null });

            migrationBuilder.InsertData(
                table: "RequestType",
                columns: new[] { "RequestTypeId", "CreateDate", "Priority", "Status", "Type", "UpdateDate" },
                values: new object[] { "1", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(2317), 1, 0, "Support", null });

            migrationBuilder.InsertData(
                table: "Revenue",
                columns: new[] { "RevenueId", "CreateDate", "RevenueDate", "Status", "TotalRevenue", "UpdateDate" },
                values: new object[] { "1", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(2166), new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(2165), 0, 900000f, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(1738), "Tour", 0, null },
                    { "2", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(1740), "Hotel", 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(1709), 0, "FPT", null },
                    { "2", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(1712), 1, "VNPT", null }
                });

            migrationBuilder.InsertData(
                table: "CustomerSupport",
                columns: new[] { "CusSupportId", "CreateDate", "DateResolved", "Description", "RequestTypeId", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(2298), new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(2297), "Support", "1", 0, null, "430f4760-a676-4dc0-8a3c-160016435da1" });

            migrationBuilder.InsertData(
                table: "Destination",
                columns: new[] { "DestinationId", "CityId", "CreateDate", "DestinationImgUrl", "DestinationName", "Status", "UpdateDate" },
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(1845), null, "Quận 1", 0, null },
                    { "2", "2", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(1847), null, "Quận 2", 1, null }
                });

            migrationBuilder.InsertData(
                table: "Notification",
                columns: new[] { "NotifyId", "CreateDate", "Message", "SendDate", "Status", "Title", "Type", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(2276), "Chúc mừng bạn đã đặt tour thành công", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(2274), 0, "Thành công", "Success", null, "430f4760-a676-4dc0-8a3c-160016435da1" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(1956), null, "Tour Hồ Chí Minh", 500000f, 0, null },
                    { "2", "2", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(1959), null, "Tour Hà Nội", 600000f, 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(1820), "1", "1", 0, null },
                    { "2", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(1822), "2", "2", 1, null }
                });

            migrationBuilder.InsertData(
                table: "Booking",
                columns: new[] { "BookingId", "BookingDate", "CreateDate", "DailyTourId", "PaymentId", "Status", "TotalPrice", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(2072), new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(2073), "1", "1", 0, 500000f, null, "430f4760-a676-4dc0-8a3c-160016435da1" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", 10, new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(1981), null, "1", 0, "1", null },
                    { "2", 10, new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(1984), null, "1", 1, "2", null }
                });

            migrationBuilder.InsertData(
                table: "PointOfInterest",
                columns: new[] { "PointId", "CreateDate", "LocationId", "POITypeId", "PointName", "Status", "UpdateDate" },
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(1901), "1", "1", "Chợ Bến Thành", 0, null },
                    { "2", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(1904), "1", "2", "Bảo tàng Hồ Chí Minh", 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(1793), "1", 0, "1", null },
                    { "2", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(1796), "2", 1, "2", null }
                });

            migrationBuilder.InsertData(
                table: "BookingByRevenue",
                columns: new[] { "BookingByRevenueId", "BookingId", "CreateDate", "RevenueId", "Status", "UpdateDate" },
                values: new object[] { "1", "1", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(2144), "1", 0, null });

            migrationBuilder.InsertData(
                table: "Feedback",
                columns: new[] { "FeedbackId", "BookingId", "CreateDate", "FeedbackMsg", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(2231), "Rất tuyệt vời", 0, null, "430f4760-a676-4dc0-8a3c-160016435da1" });

            migrationBuilder.InsertData(
                table: "Rate",
                columns: new[] { "RateId", "BookingId", "CreateDate", "RateStar", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(2254), 5, 0, null, "430f4760-a676-4dc0-8a3c-160016435da1" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(2098), 100000f, "", 10, 0, "Vé vào cổng", "1", null },
                    { "2", "1", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(2102), 50000f, "", 10, 1, "Vé ăn uống", "1", null }
                });

            migrationBuilder.InsertData(
                table: "TransactionsHistory",
                columns: new[] { "TransactionId", "BookingId", "CreateDate", "OrderId", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(2209), null, 0, null, "430f4760-a676-4dc0-8a3c-160016435da1" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(2123), "1", 0, "1", null },
                    { "2", new DateTime(2024, 9, 30, 13, 15, 58, 211, DateTimeKind.Local).AddTicks(2124), "2", 1, "2", null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingByRevenue_BookingId",
                table: "BookingByRevenue",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_BookingByRevenue_RevenueId",
                table: "BookingByRevenue",
                column: "RevenueId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PointOfInterest_POITypeId",
                table: "PointOfInterest",
                column: "POITypeId");
