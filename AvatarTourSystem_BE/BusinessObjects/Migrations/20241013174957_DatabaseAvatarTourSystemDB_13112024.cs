...
{
    /// <inheritdoc />
    public partial class DatabaseAvatarTourSystemDB_13112024 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DestinationOpeningDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DestinationClosingDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Account",
                columns: new[] { "Id", "AccessFailedCount", "Address", "AvatarUrl", "ConcurrencyStamp", "CreateDate", "Dob", "Email", "EmailConfirmed", "FullName", "Gender", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "Password", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "RefreshToken", "RefreshTokenExpiryTime", "Roles", "SecurityStamp", "Status", "TwoFactorEnabled", "UpdateDate", "UserName", "ZaloUser" },
                values: new object[] { "948403c5-0241-420d-9c05-e8fd1e7220fe", 0, "Quận 10, Hồ chí minh", "data:image/png;base64,iVBO", "bf5cce6a-328e-4240-a799-c3dedf63d321", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7331), new DateTime(1990, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "huahao04@gmail.com", false, "Hứa Thượng Hảo", true, false, null, null, null, null, null, "0395840777", false, null, null, null, "697dbdd9-8023-4293-88e4-2ac8774174bc", 0, false, null, null, "" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "Hồ Chí Minh", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7149), 0, null },
                    { "2", "Hà Nội", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7167), 1, null }
                });

            migrationBuilder.InsertData(
                table: "PaymentMethod",
                columns: new[] { "PaymentId", "CreateDate", "PaymentType", "Status", "UpdateDate" },
                values: new object[] { "1", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7875), "Momo", 0, null });

            migrationBuilder.InsertData(
                table: "RequestType",
                columns: new[] { "RequestTypeId", "CreateDate", "Priority", "Status", "Type", "UpdateDate" },
                values: new object[] { "1", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(8018), 1, 0, "Support", null });

            migrationBuilder.InsertData(
                table: "Revenue",
                columns: new[] { "RevenueId", "CreateDate", "RevenueDate", "Status", "TotalRevenue", "UpdateDate" },
                values: new object[] { "1", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7852), new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7851), 0, 900000f, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7413), "Tour", 0, null },
                    { "2", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7415), "Hotel", 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7383), 0, "FPT", null },
                    { "2", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7387), 1, "VNPT", null }
                });

            migrationBuilder.InsertData(
                table: "CustomerSupport",
                columns: new[] { "CusSupportId", "CreateDate", "DateResolved", "Description", "RequestTypeId", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7997), new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7996), "Support", "1", 0, null, "948403c5-0241-420d-9c05-e8fd1e7220fe" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7535), null, null, null, null, null, null, "Quận 1", null, null, 0, null },
                    { "2", "2", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7538), null, null, null, null, null, null, "Quận 2", null, null, 1, null }
                });

            migrationBuilder.InsertData(
                table: "Notification",
                columns: new[] { "NotifyId", "CreateDate", "Message", "SendDate", "Status", "Title", "Type", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7972), "Chúc mừng bạn đã đặt tour thành công", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7969), 0, "Thành công", "Success", null, "948403c5-0241-420d-9c05-e8fd1e7220fe" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7628), null, "Tour Hồ Chí Minh", 500000f, 0, null },
                    { "2", "2", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7630), null, "Tour Hà Nội", 600000f, 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7444), null, null, "Tour Hồ Chí Minh", null, "1", 0, "1", null },
                    { "2", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7455), null, null, "Tour Hà Nội", null, "1", 1, "2", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7571), "1", null, null, null, null, "Nhà hàng", null, 0, null },
                    { "2", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7575), "1", null, null, null, null, "Khách sạn", null, 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7709), null, "1", 0, "Vé người lớn (>=16 tuổi)", null },
                    { "2", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7713), null, "1", 1, "Vé trẻ em", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7508), "1", "1", 0, null },
                    { "2", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7510), "2", "2", 1, null }
                });

            migrationBuilder.InsertData(
                table: "Booking",
                columns: new[] { "BookingId", "BookingDate", "CreateDate", "DailyTourId", "ExpirationDate", "PaymentId", "Status", "TotalPrice", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7740), new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7742), "1", null, "1", 0, 500000f, null, "948403c5-0241-420d-9c05-e8fd1e7220fe" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", 10, new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7654), null, "1", 0, "1", null },
                    { "2", 10, new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7656), null, "1", 1, "2", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7597), "1", "Chợ Bến Thành", 0, null },
                    { "2", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7600), "1", "Bảo tàng Hồ Chí Minh", 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7482), "1", 0, "1", null },
                    { "2", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7484), "2", 1, "2", null }
                });

            migrationBuilder.InsertData(
                table: "BookingByRevenue",
                columns: new[] { "BookingByRevenueId", "BookingId", "CreateDate", "RevenueId", "Status", "UpdateDate" },
                values: new object[] { "1", "1", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7826), "1", 0, null });

            migrationBuilder.InsertData(
                table: "Feedback",
                columns: new[] { "FeedbackId", "BookingId", "CreateDate", "FeedbackMsg", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7922), "Rất tuyệt vời", 0, null, "948403c5-0241-420d-9c05-e8fd1e7220fe" });

            migrationBuilder.InsertData(
                table: "Rate",
                columns: new[] { "RateId", "BookingId", "CreateDate", "RateStar", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7946), 5, 0, null, "948403c5-0241-420d-9c05-e8fd1e7220fe" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7766), 100000f, "", 10, 0, "Vé vào cổng", "1", null },
                    { "2", "1", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7776), 50000f, "", 10, 1, "Vé ăn uống", "1", null }
                });

            migrationBuilder.InsertData(
                table: "TransactionsHistory",
                columns: new[] { "TransactionId", "BookingId", "CreateDate", "OrderId", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7898), null, 0, null, "948403c5-0241-420d-9c05-e8fd1e7220fe" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7800), "1", 0, "1", null },
                    { "2", new DateTime(2024, 10, 14, 0, 49, 57, 351, DateTimeKind.Local).AddTicks(7803), "2", 1, "2", null }
                });
