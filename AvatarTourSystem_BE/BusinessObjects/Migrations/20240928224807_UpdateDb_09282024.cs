    ...
    public partial class UpdateDb_09282024 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "c0c470f2-96d9-4d7b-a2ec-5b5bbe17669d", 0, "Quận 10, Hồ chí minh", "data:image/png;base64,iVBO", "1b975b58-670e-46ad-a8b7-0d812467f7e0", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2022), new DateTime(1990, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "huahao04@gmail.com", false, "Hứa Thượng Hảo", true, false, null, null, null, null, "0395840777", false, null, null, null, "4800c09f-7ee7-4de5-81d2-9b7f8fd1f61a", 0, false, null, null, "" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "Hồ Chí Minh", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(1819), 0, null },
                    { "2", "Hà Nội", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(1840), 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2305), "Chợ", 0, null },
                    { "2", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2307), "Bảo tàng", 1, null }
                });

            migrationBuilder.InsertData(
                table: "PaymentMethod",
                columns: new[] { "PaymentId", "CreateDate", "PaymentType", "Status", "UpdateDate" },
                values: new object[] { "1", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2642), "Momo", 0, null });

            migrationBuilder.InsertData(
                table: "RequestType",
                columns: new[] { "RequestTypeId", "CreateDate", "Priority", "Status", "Type", "UpdateDate" },
                values: new object[] { "1", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2758), 1, 0, "Support", null });

            migrationBuilder.InsertData(
                table: "Revenue",
                columns: new[] { "RevenueId", "CreateDate", "RevenueDate", "Status", "TotalRevenue", "UpdateDate" },
                values: new object[] { "1", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2623), new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2622), 0, 900000f, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2092), "Tour", 0, null },
                    { "2", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2095), "Hotel", 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2067), 0, "FPT", null },
                    { "2", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2072), 1, "VNPT", null }
                });

            migrationBuilder.InsertData(
                table: "CustomerSupport",
                columns: new[] { "CusSupportId", "CreateDate", "DateResolved", "Description", "RequestTypeId", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2740), new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2739), "Support", "1", 0, null, "c0c470f2-96d9-4d7b-a2ec-5b5bbe17669d" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2231), null, "Quận 1", 0, null },
                    { "2", "2", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2233), null, "Quận 2", 1, null }
                });

            migrationBuilder.InsertData(
                table: "Notification",
                columns: new[] { "NotifyId", "CreateDate", "Message", "SendDate", "Status", "Title", "Type", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2720), "Chúc mừng bạn đã đặt tour thành công", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2719), 0, "Thành công", "Success", null, "c0c470f2-96d9-4d7b-a2ec-5b5bbe17669d" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2390), null, "Tour Hồ Chí Minh", 500000f, 0, null },
                    { "2", "2", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2393), null, "Tour Hà Nội", 600000f, 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2120), null, null, "Tour Hồ Chí Minh", null, "1", 0, "1", null },
                    { "2", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2123), null, null, "Tour Hà Nội", null, "1", 1, "2", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2256), "1", null, "Nhà hàng", 1, 0, null },
                    { "2", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2259), "1", null, "Khách sạn", 1, 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2473), "1", 0, "Vé người lớn (>=16 tuổi)", null },
                    { "2", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2476), "1", 1, "Vé trẻ em", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2198), "1", "1", 0, null },
                    { "2", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2200), "2", "2", 1, null }
                });

            migrationBuilder.InsertData(
                table: "Booking",
                columns: new[] { "BookingId", "BookingDate", "CreateDate", "DailyTourId", "PaymentId", "Status", "TotalPrice", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2496), new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2498), "1", "1", 0, 500000f, null, "c0c470f2-96d9-4d7b-a2ec-5b5bbe17669d" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", 10, new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2417), null, "1", 0, "1", null },
                    { "2", 10, new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2420), null, "1", 1, "2", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2279), "1", "1", "Chợ Bến Thành", 0, null },
                    { "2", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2281), "1", "2", "Bảo tàng Hồ Chí Minh", 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2144), "1", 0, "1", null },
                    { "2", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2147), "2", 1, "2", null }
                });

            migrationBuilder.InsertData(
                table: "BookingByRevenue",
                columns: new[] { "BookingByRevenueId", "BookingId", "CreateDate", "RevenueId", "Status", "UpdateDate" },
                values: new object[] { "1", "1", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2597), "1", 0, null });

            migrationBuilder.InsertData(
                table: "Feedback",
                columns: new[] { "FeedbackId", "BookingId", "CreateDate", "FeedbackMsg", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2678), "Rất tuyệt vời", 0, null, "c0c470f2-96d9-4d7b-a2ec-5b5bbe17669d" });

            migrationBuilder.InsertData(
                table: "Rate",
                columns: new[] { "RateId", "BookingId", "CreateDate", "RateStar", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2702), 5, 0, null, "c0c470f2-96d9-4d7b-a2ec-5b5bbe17669d" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2521), 100000f, "", 10, 0, "Vé vào cổng", "1", null },
                    { "2", "1", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2525), 50000f, "", 10, 1, "Vé ăn uống", "1", null }
                });

            migrationBuilder.InsertData(
                table: "TransactionsHistory",
                columns: new[] { "TransactionId", "BookingId", "CreateDate", "OrderId", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2659), null, 0, null, "c0c470f2-96d9-4d7b-a2ec-5b5bbe17669d" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2576), "1", 0, "1", null },
                    { "2", new DateTime(2024, 9, 29, 5, 48, 7, 136, DateTimeKind.Local).AddTicks(2579), "2", 1, "2", null }
                });
