...
{
    /// <inheritdoc />
    public partial class DatabaseAvatarTourSystemDB_14102024 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "e2b69352-a15c-4556-ab20-500bf7907ac2", 0, "Quận 10, Hồ chí minh", "data:image/png;base64,iVBO", "a48d79fe-d8bc-4843-adbc-14765c6cbf18", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8192), new DateTime(1990, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "huahao04@gmail.com", false, "Hứa Thượng Hảo", true, false, null, null, null, null, "0395840777", false, null, null, null, "9bfc393e-0cc5-4d37-ade2-8ce70fe92864", 0, false, null, null, "" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "Hồ Chí Minh", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(7993), 0, null },
                    { "2", "Hà Nội", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8013), 1, null }
                });

            migrationBuilder.InsertData(
                table: "PaymentMethod",
                columns: new[] { "PaymentId", "CreateDate", "PaymentType", "Status", "UpdateDate" },
                values: new object[] { "1", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8767), "Momo", 0, null });

            migrationBuilder.InsertData(
                table: "RequestType",
                columns: new[] { "RequestTypeId", "CreateDate", "Priority", "Status", "Type", "UpdateDate" },
                values: new object[] { "1", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8914), 1, 0, "Support", null });

            migrationBuilder.InsertData(
                table: "Revenue",
                columns: new[] { "RevenueId", "CreateDate", "RevenueDate", "Status", "TotalRevenue", "UpdateDate" },
                values: new object[] { "1", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8745), new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8745), 0, 900000f, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8283), "Tour", 0, null },
                    { "2", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8286), "Hotel", 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8245), 0, "FPT", null },
                    { "2", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8248), 1, "VNPT", null }
                });

            migrationBuilder.InsertData(
                table: "CustomerSupport",
                columns: new[] { "CusSupportId", "CreateDate", "DateResolved", "Description", "RequestTypeId", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8894), new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8893), "Support", "1", 0, null, "e2b69352-a15c-4556-ab20-500bf7907ac2" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8403), null, null, null, null, null, null, "Quận 1", null, null, 0, null },
                    { "2", "2", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8406), null, null, null, null, null, null, "Quận 2", null, null, 1, null }
                });

            migrationBuilder.InsertData(
                table: "Notification",
                columns: new[] { "NotifyId", "CreateDate", "Message", "SendDate", "Status", "Title", "Type", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8870), "Chúc mừng bạn đã đặt tour thành công", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8865), 0, "Thành công", "Success", null, "e2b69352-a15c-4556-ab20-500bf7907ac2" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8490), null, "Tour Hồ Chí Minh", 500000f, 0, null },
                    { "2", "2", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8493), null, "Tour Hà Nội", 600000f, 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8315), null, null, "Tour Hồ Chí Minh", null, "1", 0, "1", null },
                    { "2", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8319), null, null, "Tour Hà Nội", null, "1", 1, "2", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8437), "1", null, null, null, null, "Nhà hàng", null, 0, null },
                    { "2", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8440), "1", null, null, null, null, "Khách sạn", null, 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8579), null, "1", 0, "Vé người lớn (>=16 tuổi)", null },
                    { "2", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8582), null, "1", 1, "Vé trẻ em", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8375), "1", "1", 0, null },
                    { "2", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8377), "2", "2", 1, null }
                });

            migrationBuilder.InsertData(
                table: "Booking",
                columns: new[] { "BookingId", "BookingDate", "CreateDate", "DailyTourId", "ExpirationDate", "PaymentId", "Status", "TotalPrice", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8639), new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8642), "1", null, "1", 0, 500000f, null, "e2b69352-a15c-4556-ab20-500bf7907ac2" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", 10, new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8517), null, "1", 0, "1", null },
                    { "2", 10, new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8521), null, "1", 1, "2", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8462), "1", "Chợ Bến Thành", 0, null },
                    { "2", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8465), "1", "Bảo tàng Hồ Chí Minh", 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8347), "1", 0, "1", null },
                    { "2", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8350), "2", 1, "2", null }
                });

            migrationBuilder.InsertData(
                table: "BookingByRevenue",
                columns: new[] { "BookingByRevenueId", "BookingId", "CreateDate", "RevenueId", "Status", "UpdateDate" },
                values: new object[] { "1", "1", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8720), "1", 0, null });

            migrationBuilder.InsertData(
                table: "Feedback",
                columns: new[] { "FeedbackId", "BookingId", "CreateDate", "FeedbackMsg", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8817), "Rất tuyệt vời", 0, null, "e2b69352-a15c-4556-ab20-500bf7907ac2" });

            migrationBuilder.InsertData(
                table: "Rate",
                columns: new[] { "RateId", "BookingId", "CreateDate", "RateStar", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8840), 5, 0, null, "e2b69352-a15c-4556-ab20-500bf7907ac2" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8670), 100000f, "", 10, 0, "Vé vào cổng", "1", null },
                    { "2", "1", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8674), 50000f, "", 10, 1, "Vé ăn uống", "1", null }
                });

            migrationBuilder.InsertData(
                table: "TransactionsHistory",
                columns: new[] { "TransactionId", "BookingId", "CreateDate", "OrderId", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8792), null, 0, null, "e2b69352-a15c-4556-ab20-500bf7907ac2" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8695), "1", 0, "1", null },
                    { "2", new DateTime(2024, 10, 14, 15, 55, 15, 641, DateTimeKind.Local).AddTicks(8697), "2", 1, "2", null }
                });
