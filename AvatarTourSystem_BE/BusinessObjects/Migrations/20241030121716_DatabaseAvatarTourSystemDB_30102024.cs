...
{
    /// <inheritdoc />
    public partial class DatabaseAvatarTourSystemDB_30102024 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "76240f8e-1fc2-4d54-bc54-6b9bc1f0f187", 0, "Quận 10, Hồ chí minh", "data:image/png;base64,iVBO", "860e61b3-506f-4005-87e3-10527ea18c27", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(1888), new DateTime(1990, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "huahao04@gmail.com", false, "Hứa Thượng Hảo", true, false, null, null, null, null, "0395840777", false, null, null, null, "4fe72def-51ed-45f5-938d-ec34f22cec42", 0, false, null, null, "" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "Hồ Chí Minh", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(1682), 0, null },
                    { "2", "Hà Nội", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(1699), 1, null }
                });

            migrationBuilder.InsertData(
                table: "PaymentMethod",
                columns: new[] { "PaymentMethodId", "CreateDate", "PaymentType", "Status", "UpdateDate" },
                values: new object[] { "1", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2414), "Momo", 0, null });

            migrationBuilder.InsertData(
                table: "RequestType",
                columns: new[] { "RequestTypeId", "CreateDate", "Priority", "Status", "Type", "UpdateDate" },
                values: new object[] { "1", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2580), 1, 0, "Support", null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(1977), "Tour", 0, null },
                    { "2", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(1980), "Hotel", 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(1946), 0, "FPT", null },
                    { "2", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(1948), 1, "VNPT", null }
                });

            migrationBuilder.InsertData(
                table: "CustomerSupport",
                columns: new[] { "CusSupportId", "CreateDate", "DateResolved", "Description", "RequestTypeId", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2554), new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2553), "Support", "1", 0, null, "76240f8e-1fc2-4d54-bc54-6b9bc1f0f187" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2097), null, null, null, null, null, null, "Quận 1", null, null, 0, null },
                    { "2", "2", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2100), null, null, null, null, null, null, "Quận 2", null, null, 1, null }
                });

            migrationBuilder.InsertData(
                table: "Notification",
                columns: new[] { "NotifyId", "CreateDate", "Message", "SendDate", "Status", "Title", "Type", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2530), "Chúc mừng bạn đã đặt tour thành công", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2527), 0, "Thành công", "Success", null, "76240f8e-1fc2-4d54-bc54-6b9bc1f0f187" });

            migrationBuilder.InsertData(
                table: "PackageTour",
                columns: new[] { "PackageTourId", "CityId", "CreateDate", "PackageTourImgUrl", "PackageTourName", "Status", "UpdateDate" },
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2203), null, "Tour Hồ Chí Minh", 0, null },
                    { "2", "2", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2212), null, "Tour Hà Nội", 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2010), null, null, "Tour Hồ Chí Minh", null, "1", 0, "1", null },
                    { "2", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2014), null, null, "Tour Hà Nội", null, "1", 1, "2", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2131), "1", null, null, null, null, "Nhà hàng", null, 0, null },
                    { "2", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2133), "1", null, null, null, null, "Khách sạn", null, 1, null }
                });

            migrationBuilder.InsertData(
                table: "TicketType",
                columns: new[] { "TicketTypeId", "CreateDate", "MinBuyTicket", "PackageTourId", "PriceDefault", "Status", "TicketTypeName", "UpdateDate" },
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2299), null, "1", null, 0, "Vé người lớn (>=16 tuổi)", null },
                    { "2", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2301), null, "1", null, 1, "Vé trẻ em", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2067), "1", "1", 0, null },
                    { "2", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2070), "2", "2", 1, null }
                });

            migrationBuilder.InsertData(
                table: "Booking",
                columns: new[] { "BookingId", "BookingDate", "CreateDate", "DailyTourId", "ExpirationDate", "Status", "TotalPrice", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2328), new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2330), "1", null, 0, 500000f, null, "76240f8e-1fc2-4d54-bc54-6b9bc1f0f187" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", 10, new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2238), null, "1", 0, "1", null },
                    { "2", 10, new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2240), null, "1", 1, "2", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2165), "1", "Chợ Bến Thành", 0, null },
                    { "2", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2167), "1", "Bảo tàng Hồ Chí Minh", 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2040), "1", 0, "1", null },
                    { "2", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2043), "2", 1, "2", null }
                });

            migrationBuilder.InsertData(
                table: "Feedback",
                columns: new[] { "FeedbackId", "BookingId", "CreateDate", "FeedbackMsg", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2470), "Rất tuyệt vời", 0, null, "76240f8e-1fc2-4d54-bc54-6b9bc1f0f187" });

            migrationBuilder.InsertData(
                table: "Rate",
                columns: new[] { "RateId", "BookingId", "CreateDate", "RateStar", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2499), 5, 0, null, "76240f8e-1fc2-4d54-bc54-6b9bc1f0f187" });

            migrationBuilder.InsertData(
                table: "Ticket",
                columns: new[] { "TicketId", "BookingId", "CreateDate", "DailyTicketId", "PhoneNumberReference", "Price", "QRImgUrl", "Quantity", "Status", "TicketName", "UpdateDate" },
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2358), "1", null, 100000f, "", 10, 0, "Vé vào cổng", null },
                    { "2", "1", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2360), "1", null, 50000f, "", 10, 1, "Vé ăn uống", null }
                });

            migrationBuilder.InsertData(
                table: "TransactionsHistory",
                columns: new[] { "TransactionId", "BookingId", "CreateDate", "OrderId", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2444), null, 0, null, "76240f8e-1fc2-4d54-bc54-6b9bc1f0f187" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2382), "1", 0, "1", null },
                    { "2", new DateTime(2024, 10, 30, 19, 17, 16, 436, DateTimeKind.Local).AddTicks(2384), "2", 1, "2", null }
                });
