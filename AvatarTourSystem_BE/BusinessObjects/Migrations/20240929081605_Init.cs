    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "03d5a76f-9fe1-4498-a10c-f720de2d3f77", 0, "Quận 10, Hồ chí minh", "data:image/png;base64,iVBO", "19f099f9-50fe-4de0-9c6e-21179df4d855", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8452), new DateTime(1990, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "huahao04@gmail.com", false, "Hứa Thượng Hảo", true, false, null, null, null, null, "0395840777", false, null, null, null, "93a9253f-c75d-453e-bf6f-95e597e69a6e", 0, false, null, null, "" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "Hồ Chí Minh", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8084), 0, null },
                    { "2", "Hà Nội", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8098), 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8716), "Chợ", 0, null },
                    { "2", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8718), "Bảo tàng", 1, null }
                });

            migrationBuilder.InsertData(
                table: "PaymentMethod",
                columns: new[] { "PaymentId", "CreateDate", "PaymentType", "Status", "UpdateDate" },
                values: new object[] { "1", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8978), "Momo", 0, null });

            migrationBuilder.InsertData(
                table: "RequestType",
                columns: new[] { "RequestTypeId", "CreateDate", "Priority", "Status", "Type", "UpdateDate" },
                values: new object[] { "1", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(9133), 1, 0, "Support", null });

            migrationBuilder.InsertData(
                table: "Revenue",
                columns: new[] { "RevenueId", "CreateDate", "RevenueDate", "Status", "TotalRevenue", "UpdateDate" },
                values: new object[] { "1", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8957), new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8957), 0, 900000f, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8527), "Tour", 0, null },
                    { "2", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8529), "Hotel", 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8503), 0, "FPT", null },
                    { "2", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8505), 1, "VNPT", null }
                });

            migrationBuilder.InsertData(
                table: "CustomerSupport",
                columns: new[] { "CusSupportId", "CreateDate", "DateResolved", "Description", "RequestTypeId", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(9114), new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(9114), "Support", "1", 0, null, "03d5a76f-9fe1-4498-a10c-f720de2d3f77" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8632), null, "Quận 1", 0, null },
                    { "2", "2", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8634), null, "Quận 2", 1, null }
                });

            migrationBuilder.InsertData(
                table: "Notification",
                columns: new[] { "NotifyId", "CreateDate", "Message", "SendDate", "Status", "Title", "Type", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(9089), "Chúc mừng bạn đã đặt tour thành công", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(9085), 0, "Thành công", "Success", null, "03d5a76f-9fe1-4498-a10c-f720de2d3f77" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8743), null, "Tour Hồ Chí Minh", 500000f, 0, null },
                    { "2", "2", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8746), null, "Tour Hà Nội", 600000f, 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8555), null, null, "Tour Hồ Chí Minh", null, "1", 0, "1", null },
                    { "2", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8559), null, null, "Tour Hà Nội", null, "1", 1, "2", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8659), "1", null, "Nhà hàng", 1, 0, null },
                    { "2", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8663), "1", null, "Khách sạn", 1, 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8823), "1", 0, "Vé người lớn (>=16 tuổi)", null },
                    { "2", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8826), "1", 1, "Vé trẻ em", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8606), "1", "1", 0, null },
                    { "2", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8608), "2", "2", 1, null }
                });

            migrationBuilder.InsertData(
                table: "Booking",
                columns: new[] { "BookingId", "BookingDate", "CreateDate", "DailyTourId", "PaymentId", "Status", "TotalPrice", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8851), new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8853), "1", "1", 0, 500000f, null, "03d5a76f-9fe1-4498-a10c-f720de2d3f77" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", 10, new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8769), null, "1", 0, "1", null },
                    { "2", 10, new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8772), null, "1", 1, "2", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8690), "1", "1", "Chợ Bến Thành", 0, null },
                    { "2", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8692), "1", "2", "Bảo tàng Hồ Chí Minh", 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8581), "1", 0, "1", null },
                    { "2", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8583), "2", 1, "2", null }
                });

            migrationBuilder.InsertData(
                table: "BookingByRevenue",
                columns: new[] { "BookingByRevenueId", "BookingId", "CreateDate", "RevenueId", "Status", "UpdateDate" },
                values: new object[] { "1", "1", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8933), "1", 0, null });

            migrationBuilder.InsertData(
                table: "Feedback",
                columns: new[] { "FeedbackId", "BookingId", "CreateDate", "FeedbackMsg", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(9027), "Rất tuyệt vời", 0, null, "03d5a76f-9fe1-4498-a10c-f720de2d3f77" });

            migrationBuilder.InsertData(
                table: "Rate",
                columns: new[] { "RateId", "BookingId", "CreateDate", "RateStar", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(9059), 5, 0, null, "03d5a76f-9fe1-4498-a10c-f720de2d3f77" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8878), 100000f, "", 10, 0, "Vé vào cổng", "1", null },
                    { "2", "1", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8881), 50000f, "", 10, 1, "Vé ăn uống", "1", null }
                });

            migrationBuilder.InsertData(
                table: "TransactionsHistory",
                columns: new[] { "TransactionId", "BookingId", "CreateDate", "OrderId", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(9003), null, 0, null, "03d5a76f-9fe1-4498-a10c-f720de2d3f77" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8907), "1", 0, "1", null },
                    { "2", new DateTime(2024, 9, 29, 15, 16, 4, 949, DateTimeKind.Local).AddTicks(8910), "2", 1, "2", null }
                });
