...
{
    /// <inheritdoc />
    public partial class UpdateDb_09282024 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "af447c65-f339-451b-85d8-57cbe8b7bcd0", 0, "Quận 10, Hồ chí minh", "data:image/png;base64,iVBO", "1e8295d3-fcc8-4b4d-94c6-fee6ee0a7584", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1312), new DateTime(1990, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "huahao04@gmail.com", false, "Hứa Thượng Hảo", true, false, null, null, null, null, "0395840777", false, null, null, null, "625b7f59-b880-43e1-9274-61b03d75b799", 0, false, null, null, "" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "Hồ Chí Minh", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1104), 0, null },
                    { "2", "Hà Nội", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1126), 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1575), "Chợ", 0, null },
                    { "2", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1577), "Bảo tàng", 1, null }
                });

            migrationBuilder.InsertData(
                table: "PaymentMethod",
                columns: new[] { "PaymentId", "CreateDate", "PaymentType", "Status", "UpdateDate" },
                values: new object[] { "1", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1816), "Momo", 0, null });

            migrationBuilder.InsertData(
                table: "RequestType",
                columns: new[] { "RequestTypeId", "CreateDate", "Priority", "Status", "Type", "UpdateDate" },
                values: new object[] { "1", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1923), 1, 0, "Support", null });

            migrationBuilder.InsertData(
                table: "Revenue",
                columns: new[] { "RevenueId", "CreateDate", "RevenueDate", "Status", "TotalRevenue", "UpdateDate" },
                values: new object[] { "1", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1799), new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1798), 0, 900000f, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1408), "Tour", 0, null },
                    { "2", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1412), "Hotel", 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1382), 0, "FPT", null },
                    { "2", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1387), 1, "VNPT", null }
                });

            migrationBuilder.InsertData(
                table: "CustomerSupport",
                columns: new[] { "CusSupportId", "CreateDate", "DateResolved", "Description", "RequestTypeId", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1907), new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1906), "Support", "1", 0, null, "af447c65-f339-451b-85d8-57cbe8b7bcd0" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1508), null, "Quận 1", 0, null },
                    { "2", "2", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1510), null, "Quận 2", 1, null }
                });

            migrationBuilder.InsertData(
                table: "Notification",
                columns: new[] { "NotifyId", "CreateDate", "Message", "SendDate", "Status", "Title", "Type", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1882), "Chúc mừng bạn đã đặt tour thành công", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1881), 0, "Thành công", "Success", null, "af447c65-f339-451b-85d8-57cbe8b7bcd0" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1600), null, "Tour Hồ Chí Minh", 500000f, 0, null },
                    { "2", "2", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1602), null, "Tour Hà Nội", 600000f, 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1441), null, null, "Tour Hồ Chí Minh", null, "1", 0, "1", null },
                    { "2", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1443), null, null, "Tour Hà Nội", null, "1", 1, "2", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1534), "1", null, "Nhà hàng", 1, 0, null },
                    { "2", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1536), "1", null, "Khách sạn", 1, 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1686), "1", 0, "Vé người lớn (>=16 tuổi)", null },
                    { "2", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1688), "1", 1, "Vé trẻ em", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1488), "1", "1", 0, null },
                    { "2", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1490), "2", "2", 1, null }
                });

            migrationBuilder.InsertData(
                table: "Booking",
                columns: new[] { "BookingId", "BookingDate", "CreateDate", "DailyTourId", "PaymentId", "Status", "TotalPrice", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1708), new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1709), "1", "1", 0, 500000f, null, "af447c65-f339-451b-85d8-57cbe8b7bcd0" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", 10, new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1622), null, "1", 0, "1", null },
                    { "2", 10, new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1624), null, "1", 1, "2", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1554), "1", "1", "Chợ Bến Thành", 0, null },
                    { "2", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1556), "1", "2", "Bảo tàng Hồ Chí Minh", 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1465), "1", 0, "1", null },
                    { "2", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1468), "2", 1, "2", null }
                });

            migrationBuilder.InsertData(
                table: "BookingByRevenue",
                columns: new[] { "BookingByRevenueId", "BookingId", "CreateDate", "RevenueId", "Status", "UpdateDate" },
                values: new object[] { "1", "1", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1776), "1", 0, null });

            migrationBuilder.InsertData(
                table: "Feedback",
                columns: new[] { "FeedbackId", "BookingId", "CreateDate", "FeedbackMsg", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1849), "Rất tuyệt vời", 0, null, "af447c65-f339-451b-85d8-57cbe8b7bcd0" });

            migrationBuilder.InsertData(
                table: "Rate",
                columns: new[] { "RateId", "BookingId", "CreateDate", "RateStar", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1864), 5, 0, null, "af447c65-f339-451b-85d8-57cbe8b7bcd0" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1732), 100000f, "", 10, 0, "Vé vào cổng", "1", null },
                    { "2", "1", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1735), 50000f, "", 10, 1, "Vé ăn uống", "1", null }
                });

            migrationBuilder.InsertData(
                table: "TransactionsHistory",
                columns: new[] { "TransactionId", "BookingId", "CreateDate", "OrderId", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1831), null, 0, null, "af447c65-f339-451b-85d8-57cbe8b7bcd0" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1754), "1", 0, "1", null },
                    { "2", new DateTime(2024, 9, 29, 6, 39, 55, 261, DateTimeKind.Local).AddTicks(1757), "2", 1, "2", null }
                });
