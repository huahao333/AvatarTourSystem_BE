    ...
    public partial class DatabaseAvatarTourSystemDB_30102024 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "ebdf1728-3465-4ce6-93ec-51eda3d064ff", 0, "Quận 10, Hồ chí minh", "data:image/png;base64,iVBO", "9e99822a-243d-4e38-b70e-e375d78dd49e", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9481), new DateTime(1990, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "huahao04@gmail.com", false, "Hứa Thượng Hảo", true, false, null, null, null, null, "0395840777", false, null, null, null, "7b745ef1-0170-4843-aa3d-ec8bfa305ea1", 0, false, null, null, "" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "Hồ Chí Minh", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9158), 0, null },
                    { "2", "Hà Nội", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9174), 1, null }
                });

            migrationBuilder.InsertData(
                table: "PaymentMethod",
                columns: new[] { "PaymentMethodId", "CreateDate", "PaymentType", "Status", "UpdateDate" },
                values: new object[] { "1", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9965), "Momo", 0, null });

            migrationBuilder.InsertData(
                table: "RequestType",
                columns: new[] { "RequestTypeId", "CreateDate", "Priority", "Status", "Type", "UpdateDate" },
                values: new object[] { "1", new DateTime(2024, 10, 30, 18, 43, 20, 523, DateTimeKind.Local).AddTicks(110), 1, 0, "Support", null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9563), "Tour", 0, null },
                    { "2", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9566), "Hotel", 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9535), 0, "FPT", null },
                    { "2", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9537), 1, "VNPT", null }
                });

            migrationBuilder.InsertData(
                table: "CustomerSupport",
                columns: new[] { "CusSupportId", "CreateDate", "DateResolved", "Description", "RequestTypeId", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 10, 30, 18, 43, 20, 523, DateTimeKind.Local).AddTicks(89), new DateTime(2024, 10, 30, 18, 43, 20, 523, DateTimeKind.Local).AddTicks(88), "Support", "1", 0, null, "ebdf1728-3465-4ce6-93ec-51eda3d064ff" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9686), null, null, null, null, null, null, "Quận 1", null, null, 0, null },
                    { "2", "2", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9689), null, null, null, null, null, null, "Quận 2", null, null, 1, null }
                });

            migrationBuilder.InsertData(
                table: "Notification",
                columns: new[] { "NotifyId", "CreateDate", "Message", "SendDate", "Status", "Title", "Type", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 10, 30, 18, 43, 20, 523, DateTimeKind.Local).AddTicks(67), "Chúc mừng bạn đã đặt tour thành công", new DateTime(2024, 10, 30, 18, 43, 20, 523, DateTimeKind.Local).AddTicks(65), 0, "Thành công", "Success", null, "ebdf1728-3465-4ce6-93ec-51eda3d064ff" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9774), null, "Tour Hồ Chí Minh", 500000f, 0, null },
                    { "2", "2", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9779), null, "Tour Hà Nội", 600000f, 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9606), null, null, "Tour Hồ Chí Minh", null, "1", 0, "1", null },
                    { "2", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9609), null, null, "Tour Hà Nội", null, "1", 1, "2", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9716), "1", null, null, null, null, "Nhà hàng", null, 0, null },
                    { "2", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9718), "1", null, null, null, null, "Khách sạn", null, 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9855), null, "1", null, 0, "Vé người lớn (>=16 tuổi)", null },
                    { "2", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9858), null, "1", null, 1, "Vé trẻ em", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9660), "1", "1", 0, null },
                    { "2", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9662), "2", "2", 1, null }
                });

            migrationBuilder.InsertData(
                table: "Booking",
                columns: new[] { "BookingId", "BookingDate", "CreateDate", "DailyTourId", "ExpirationDate", "Status", "TotalPrice", "UpdateDate", "UserId" },
                values: new object[] { "1", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9881), new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9883), "1", null, 0, 500000f, null, "ebdf1728-3465-4ce6-93ec-51eda3d064ff" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", 10, new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9801), null, "1", 0, "1", null },
                    { "2", 10, new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9804), null, "1", 1, "2", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9744), "1", "Chợ Bến Thành", 0, null },
                    { "2", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9746), "1", "Bảo tàng Hồ Chí Minh", 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9633), "1", 0, "1", null },
                    { "2", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9636), "2", 1, "2", null }
                });

            migrationBuilder.InsertData(
                table: "Feedback",
                columns: new[] { "FeedbackId", "BookingId", "CreateDate", "FeedbackMsg", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 10, 30, 18, 43, 20, 523, DateTimeKind.Local).AddTicks(17), "Rất tuyệt vời", 0, null, "ebdf1728-3465-4ce6-93ec-51eda3d064ff" });

            migrationBuilder.InsertData(
                table: "Rate",
                columns: new[] { "RateId", "BookingId", "CreateDate", "RateStar", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 10, 30, 18, 43, 20, 523, DateTimeKind.Local).AddTicks(41), 5, 0, null, "ebdf1728-3465-4ce6-93ec-51eda3d064ff" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9915), "1", null, 100000f, "", 10, 0, "Vé vào cổng", null },
                    { "2", "1", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9919), "1", null, 50000f, "", 10, 1, "Vé ăn uống", null }
                });

            migrationBuilder.InsertData(
                table: "TransactionsHistory",
                columns: new[] { "TransactionId", "BookingId", "CreateDate", "OrderId", "Status", "UpdateDate", "UserId" },
                values: new object[] { "1", "1", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9994), null, 0, null, "ebdf1728-3465-4ce6-93ec-51eda3d064ff" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9940), "1", 0, "1", null },
                    { "2", new DateTime(2024, 10, 30, 18, 43, 20, 522, DateTimeKind.Local).AddTicks(9943), "2", 1, "2", null }
                });
